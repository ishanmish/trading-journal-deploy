...
const TradingJournal = () => {
    ...
    useEffect(() => {
        ...
        // 2. Aggregate by Date for Stats & Chart
        const dailyMap = {};
        processed.forEach(e => {
        ...
        const totalPnL = dailyAggregated.reduce((sum, e) => sum + e.pnl, 0);
    ...
    return (
        <div className="min-h-screen bg-[#050505] font-sans text-[#ededed] p-8 max-w-[1600px] mx-auto">
            ...
            <div className="mt-8 flex justify-between items-center mb-4">
                ...
                <button onClick={() => setIsModalOpen(true)} className="bg-[#eab308] text-black px-4 py-1.5 rounded-lg text-sm font-bold shadow-lg hover:bg-yellow-400 transition-colors">
                    + Log Day
                </button>
            </div>
